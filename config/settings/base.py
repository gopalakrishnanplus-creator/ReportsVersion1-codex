...
SAPA_ETL = {
    ...
    "ENABLE_LEGACY_V2_FALLBACKS": _env_bool("SAPA_ENABLE_LEGACY_V2_FALLBACKS", default=False),
}
...
PE_REPORTS = {
    ...
    "ENABLE_LEGACY_V2_FALLBACKS": _env_bool("PE_REPORTS_ENABLE_LEGACY_V2_FALLBACKS", default=False),
}
