...
MYSQL_TABLE_SPECS: dict[str, SourceTableSpec] = {
    ...
    "campaign_brand": SourceTableSpec(
        ...
        columns=["id", "brand_uuid", "legacy_brand_id", "name", "display_name"],
        key_columns=["id"],
    ...
    "rfa_activity_event": SourceTableSpec(
        ...
        raw_table="rfa_activity_event_raw",
        columns=[
            "activity_event_uuid",
            "activity_type",
            "doctor_uuid",
            "campaign_uuid",
            "field_rep_uuid_at_event_time",
            "source_event_id",
            "event_at",
            "patient_id_raw",
            "form_id_raw",
