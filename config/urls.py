...
from dashboard.views import (
    ...
    campaign_state_attention_summary,
    campaign_state_list,
    etl_debug_page,
...
urlpatterns = [
    ...
    path("campaign/<str:brand_campaign_id>/states/summary/", campaign_state_attention_summary, name="campaign-state-attention-summary"),
